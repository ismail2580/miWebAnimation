...
$(document).ready(function () {
  $(window).scroll(function () {
    if ($(this).scrollTop() > 1350) {
      $(".fixedImageSlide").css({backgroundImage : "url('imges/slideImageMane.jpg')"});
    } else {
      $(".fixedImageSlide").css({ backgroundImage: "url('imges/slideImageFemail.jpg')" });
    }
  });
});
...
$(document).ready(function () {
  $(window).scroll(function () {
    if ($(this).scrollTop() > 2020) {
      $(".TextOnlyTextPage").css({ opacity: "0" });
    } else {
      $(".TextOnlyTextPage").css({ opacity: "1" });
    }
  });
});
...
$(document).ready(function () {
  $(window).scroll(function () {
    if ($(this).scrollTop() > 4450) {
      $(".singleLineText").css({ opacity: "0" });
    } else {
      $(".singleLineText").css({ opacity: "1" });
    }
  });
});
// $(document).ready(function () {
//   $(window).scroll(function () {
//     if ($(this).scrollTop() > 5270) {
//       $(".Bacgroundimg").css({ "padding-left": "0" });
//     } else {
//       $(".Bacgroundimg").css({ "padding-left": "1461px" });
//     }
//   });
// });
// $(document).ready(function () {
...
//       $(".topleyar").css({ "padding-right": "1461px" });
//     } else {
//       $(".topleyar").css({ "padding:": "0px" });
//     }
//   });
// });
// $(document).ready(function () {
...
// BacgroundMinImage = document.getElementById("BacgroundMinImage");
...
//   if (value > 5000) {
//     BacgroundMinImage.style.paddingLeft= value + 'px';
//   } else {
//     BacgroundMinImage.style.paddingLeft = "1171px";
//   }
// }
let BacgroundMinImage = document.getElementById('BacgroundMinImage');
let newpadding = 1171
window.addEventListener('scroll',function(){
    ...
    if(value > 5500){
      newpadding -= 20
      BacgroundMinImage.style.paddingLeft = newpadding + "px"
...
// $(document).ready(function(){
//   $(window).scroll(function(){
//       if($(this).scrollTop() >6070){
//           $('.imageZome').css({"transform":"scale('1')"})

//       }
//       else{
//           $('.imageZome').css({"transform":"scale('3')"})
//       }
//   })
// })
imageZome = document.getElementById("imageZome");
...
function scrollFunction() {
  if (
    ...
    imageZome.style.transform = "scale(1)";
  } else {
    imageZome.style.transform = "scale(3)";
  }
}

$(document).ready(function () {
  $(window).scroll(function () {
    if ($(this).scrollTop() > 12350) {
      $(".MobaileSalfeReviw").css({ opacity: "0" });
    } else {
      $(".MobaileSalfeReviw").css({ opacity: "1" });
    }
  });
});
$(document).ready(function () {
  $(window).scroll(function () {
    if ($(this).scrollTop() > 20350) {
      $(".prossesorConifiger").css({ opacity: "0" });
    } else {
      $(".prossesorConifiger").css({ opacity: "1" });
    }
  });
});
$(document).ready(function () {
  $(window).scroll(function () {
    if ($(this).scrollTop() > 22350) {
      $(".IconCardSection").css({ opacity: "0" });
    } else {
      $(".IconCardSection").css({ opacity: "1" });
    }
  });
});
// When the user scrolls down 20px from the top of the document, show the button
